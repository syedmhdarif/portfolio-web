      ...
      "script:ld+json": {
        ...
        "@graph": [
          ...
          },
          {
            ...
            "@id": `${SITE_URL}/#lokalgig`,
            name: "LokalGig",
            alternateName: "LokalGig Malaysia",
            description:
              "A Malaysian local services marketplace connecting freelancers with clients for everyday gigs and side projects. Built with React, TypeScript, Supabase, and Vercel.",
            applicationCategory: "BusinessApplication",
            operatingSystem: "Web",
            url: "https://lokalgig.my/",
            inLanguage: "en-MY",
            author: { "@id": `${SITE_URL}/#person` },
            creator: { "@id": `${SITE_URL}/#person` },
